...
<div  className=" bg-gradient-to-r from-stone-950 to-transparent">
  ...
  <div className="w-screen flex px-4  lg:flex-row items-center  lg:justify-center">
    ...
    <div className="flex  flex-col items-center lg:w-full opacity-85 justify-center text-center lg:text-left">
      <h1 className="mt-16 leading-loose text-3xl lg:text-4xl text-center text-stone-50 font-bold">
        MAKE ALL <span className="bg-rose-700 p-2 mb-2 inline-block">YOUR TRANSACTIONS</span> IN ONE APP.<br/> RECEIVE, SEND, DEPOSIT
      </h1>
  ...
  <button
    ...
    className="bg-gradient-to-r from-stone-600 to-rose-600 text-slate-200 font-bold rounded-md lg:rounded-full px-20 py-3 transition-transform transform hover:scale-105 w-full lg:w-auto"
  >
    Start Now
  </button>
  <button
